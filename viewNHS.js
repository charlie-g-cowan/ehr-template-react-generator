...
import { NHSFormControl } from "./nhsuk-frontend-react/NHSComponents";
...
function jsonFormTextInputToReactInput(jsonFormInputObject) {
    return <NHSFormControl name={jsonFormInputObject.name} key={jsonFormInputObject.key} label={jsonFormInputObject.label} help={jsonFormInputObject.help} type="text"/>;
}
